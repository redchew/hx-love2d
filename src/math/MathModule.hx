...
extern class MathModule
{
	...
	@:overload(function (color:Table<Dynamic,Dynamic>) : Float {})
	@:overload(function (c:Float) : Float {})
	public static function gammaToLinear(r:Float, g:Float, b:Float) : Float;

	public static function getRandomSeed() : Float;
	...
	public static function linearToGamma(lr:Float, lg:Float, lb:Float) : Float;
